...
def get_image_paths(images_dir, max_num_images=100000):
...
def plot_results(results):
    ...
    results_img_1 = get_concatenated_images(results_files[:10]) 
    results_img_2 = get_concatenated_images(results_files[10:])
...
def pdf_results(results_list, out_filename="pdf", incl_timestamp=True):
    pdf_dir = f"/gdrive/My Drive/Tavsiye_Sistemi/output/pdfs/"
...
if __name__ == "__main__":
    ...
    out_dir = "/gdrive/My Drive/Tavsiye_Sistemi/output"
